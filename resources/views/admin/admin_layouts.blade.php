...
<html lang="en">
  <head>
    ...
    <title>MediCure- Admin Panel </title>
...
<!-- Datatable css -->
  ...
  <body>
     ...
     @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>MediCure</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('backend/img/logo.png') }} " class="wd-32 rounded-circle" alt="">
            </a>
