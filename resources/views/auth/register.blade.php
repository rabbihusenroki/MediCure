            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        ...
                        <p>To access medicure shopping services.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="{{route('register')}}" method="post" class="ltn__form-box contact-form-box">
                            @csrf
                            <input class="@error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Your Name">
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
